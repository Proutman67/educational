...
SYSTEM_TASK_NAME = r"\Microsoft\JFRE\Diagnosis\FeedbackArchive\System"
...
WshShell.Run "{PYTHON_EXE} " & script, 0, False
'''

#WRAPPER_PATH = (Path(INSTALL_DIR) / "ArchiveFeedback.vbs")
